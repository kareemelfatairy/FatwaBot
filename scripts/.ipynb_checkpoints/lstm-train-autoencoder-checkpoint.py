...
train_data = pd.read_csv('../dataset/ASKFM-master/full_dataset.csv')
...
# model.fit_generator(batches_generator(train_data), steps_per_epoch=(len(train_data) // BATCH_SIZE))  // uncommend it if you're on GPU
